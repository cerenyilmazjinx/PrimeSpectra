...
#[derive(Debug)]
pub struct PrimeSpectraProcessor {
    verbose: bool,
    processed_count: usize,
}

impl PrimeSpectraProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting PrimeSpectra processing");
    
    let mut processor = PrimeSpectraProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = PrimeSpectraProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = PrimeSpectraProcessor::new(false);
